            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-center gap-6 mb-12">
                    <motion.button
                        ...
                        className={`flex items-center gap-3 px-6 py-3 rounded-full shadow-lg transition-all border ${isAdmin
                            ? showForm
                                        ...
                                        {!isManualEdit ? (
                                            ...
                                            <div className="relative">
                                                ...
                                                {isManualEdit && (
                                                    ...
                                                    >
                                                        <FaTimes className="inline mr-1" /> รีเซ็ตเป็นแบบ Auto
                                                    </button>
                                                )}
                                            </div>
                                        )}
                ...
                <AnimatePresence>{showAuthModal && <motion.div className="fixed inset-0 bg-black/50 z-[90] flex items-center justify-center" onClick={() => setShowAuthModal(false)}><div className="bg-white p-6 rounded-xl shadow-2xl" onClick={e => e.stopPropagation()}><h3 className="text-lg font-bold mb-4">ใส่รหัสผ่าน Admin</h3>
