  ...
  return (
    <Link href={`/work/${slug}`} className="group">
     ...
     justify-center mb-6 relative overflow-hidden bg-[#f4f4f4]"   >
        ...
        absolute top-6 left-6 capitalize">{category}</Badge>
        <Image src={img} fill priority quality={100} className="object-cover
        grou
        p-hover:scale-105 transition-all duration-500 "/> 
      </div>
