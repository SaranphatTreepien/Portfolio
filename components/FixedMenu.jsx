...
const FixedMenu = () => {
  ...
  const [isMounted, setIsMounted] = useState(false); //ensure component is mounted before rendering
  ...
  useEffect(() => {
    if (isMounted) {
      const handleScroll = () => {
        setShowMenuButton(window.scrollY > 150); // show menu button
        // after 150px scroll
      };
      if (!isMobile) {
      ...
      <AnimatePresence>
        {showMenu && showMenuButton && (
          ...
          >
            ...
            mx-auto py-12 xl:py-12 xl:px-32 flex items-center gap-12 rounded-lg "
            >
              <Nav
                containerStyles="md:border-r border-secondary/20 md:pr-12 w-full
                md:w-auto text-center md:text-left ml-4"
              ...
              <div className="hidden md:flex mx-auto">
                <div className="mx-auto">
                  ...
                  iconStyles="text-[20px] w-[32px] h-[32px] flex 
