...
// sample data for project with verious
const slides = [
  {
    img: "/assets/testimonial/img-1.png",
    name: "Emma JohnSon",
    message:
      "The service was fantastic! I couldn't be happier with the results. Highly recommended!",
  },
  {
    img: "/assets/testimonial/img-2.png",
    name: "Sophia Martinezs",
    message:
      "I couldn't be happier with the results. The website looks amazing and functions perfectly.",
  },
  {
  ...
  },
  {
    ...
    name: "Olivia Brown",
    message:
      "Everything was delivered on time , and the team was very professional throughout the process.",
  },
  {
      ...
      text-center xl:text-left mx-auto xl:mx-0"
        ...
        hover:bg-accent-hover transition-all duration-300"
          ...
          <Swiper
            ...
            onSlideChange={(swiper) => setActiveSlide(swiper.realIndex)} // update active index on slide change
            modules={[Autoplay]}
